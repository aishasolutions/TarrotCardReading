    ...
    function tirageAleatoire(Numero)
    {
            if(!TirageEffectue[Numero])
            {
              ...
              {       
                  ...
                  Element.innerHTML = '<a href=""> <img src="../assests/images/card.png" alt="card" class="back-card"> <img src="../assests/images/card/' + Aleatoire + '.jpg" alt="card" class="hidden-card"> </a>'
